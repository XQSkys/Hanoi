...
fill(0, 200, 0);                       //malt den Load button grün über
       ...
       if (mousePressed) {                   //wenn die maus auf den kooardinaten des Load buttons, er ist nun grün, und ein mausklick gemacht wird tue:
        ...
        webImg2 = loadImage("http://madouc.freeservers.com/hanoi/bild.png");
           bild = loadImage("bild.png");          //lade in den bild speicher das bild mit dem namen bild.png aus dem haubptordner
    ...
    image(bild, 0, 0);  // Füge das bild ein -- vollständiges ersetzen des programm fenster inhalts
        ...
        else if (webImg2 != null){
      image(webImg2, 0, 0);}else{//wenn kein bild gefunnden wurde also bild==0
