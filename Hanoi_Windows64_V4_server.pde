...
//rechter turm
  ...
  int check=0;
  color seeC=color(255);    //variable für die erkennung der steine, nicht standartkonforme verwendung der get(), ist bei dem farbwert weiss anders als bei allen anderen farben
  int x=0;
